    ...
    <section className="relative w-full overflow-hidden px-4 sm:px-6 lg:px-8 py-6">
      <div className="max-w-[1400px] mx-auto w-full h-full relative min-h-[600px]">
        ...
        <div className="absolute top-0 left-0 z-10 w-full max-w-2xl flex flex-col items-start pointer-events-none">
          <div className="bg-[var(--color-surface)] dark:bg-[var(--color-section)] w-fit p-4 relative pointer-events-auto">
            <h1 className="whitespace-nowrap text-2xl sm:text-5xl lg:text-7xl font-medium tracking-tight text-[var(--color-surface-foreground)] dark:text-[var(--color-section-foreground)] leading-[1.1] font-[family-name:var(--font-display)]">
              {tagline1}
            </h1>
            <svg
              width="40"
          ...
          <div className="mt-8 ml-4 lg:hidden">
            <motion.button
              className="px-6 py-3 bg-[var(--color-surface)] text-[var(--color-surface-foreground)] font-medium text-sm flex items-center gap-2 hover:bg-[var(--color-surface-hover)] transition-colors shadow-lg cursor-pointer"
