...
import { StreamerDetailHero, StreamerDetailProfile, SectionHeading, StarRatingDisplay } from "@maingame/components";
            ...
            <div>
              ...
              <dl className="mt-3 space-y-3">
                ...
                <div className="flex justify-between gap-4 border-b border-[var(--color-border-light)] pb-3">
                  ...
                  <dd className="text-sm font-medium text-[var(--color-foreground)]">{streamer.gender ?? "—"}</dd>
                </div>
                <div className="flex justify-between gap-4 border-b border-[var(--color-border-light)] pb-3">
                  <dt className="text-sm text-[var(--color-muted-foreground)]">Language</dt>
                  <dd className="text-sm font-medium text-[var(--color-foreground)]">{streamer.language ?? "—"}</dd>
                </div>
                <div className="flex justify-between gap-4">
                  <dt className="text-sm text-[var(--color-muted-foreground)]">Birth Date</dt>
                  <dd className="text-sm font-medium text-[var(--color-foreground)]">
                    {new Date(streamer.birthDate ?? "").toLocaleDateString("en-US", {
                      year: "numeric",
                      month: "short",
                      day: "numeric",
                    })}
